      ...
      foreach ($result as $res) {
        ...
        <div>
          <p id="doctolib_home" class="doctolib_home">
            <span id="subject" class="subject"><a href="doctolib_forum_page.php?topic=<?php echo $res['subject']; ?>"><?php echo $res['subject']; ?></a></span>
